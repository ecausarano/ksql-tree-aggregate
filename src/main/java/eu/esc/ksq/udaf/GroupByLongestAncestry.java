...
// @UdafDescription(name = "LongestAncestry", description = "Used in GroupBy operations, groups inputs by the longest substring representing the elements common ancestors.")
public class GroupByLongestAncestry {

//   @UdafFactory(description = "Groups by ancestry")
//   // Can be used with table aggregations
//   public static TableUdaf<String, List<String>, String> createSumLong() {

//     return new TableUdaf<String, List<String>, String>() {
